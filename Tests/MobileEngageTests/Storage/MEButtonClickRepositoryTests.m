...
SPEC_BEGIN(MEButtonClickRepositoryTests)
    ...
    describe(@"repository", ^{
        ...
        it(@"should delete element from database", ^{
            MEButtonClick *buttonClickFirst = [[MEButtonClick alloc] initWithCampaignId:@"kamp1" buttonId:@"button1" timestamp:[NSDate date]];
            MEButtonClick *buttonClickSecond = [[MEButtonClick alloc] initWithCampaignId:@"kamp2" buttonId:@"button2" timestamp:[NSDate date]];
